    ...
    return (
        <svg viewBox="0 0 153.905 48" xmlns="http://www.w3.org/2000/svg">
            <g transform="matrix(1, 0, 0, 1, -104.663849, -9.314347)">
                ...
                <text onMouseOver={handleMouseEnter} onMouseLeave={handleMouseLeave} style={{ fill: props.yucolor, fontFamily: "Outfit", fontSize: "28px", fontWeight: "600", whiteSpace: "pre" }} y="-0.144">
